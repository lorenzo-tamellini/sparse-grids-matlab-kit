function [X,W] = compute_BetaLejaKnotsAndWeights50(alpha,beta,whichrho)
%
% [X,W] = compute_BetaLejaKnotsAndWeights50(alpha,beta)
%
% returns 50 collocation points, stored in the vector X of length n,
% and the corresponding weights, stored in the matrix W of dim. nxn
...
%
%
% [X,W]=compute_BetaLejaKnotsAndWeights50(alpha,beta,'prob') 
% 
% is the same as [X,W]=compute_BetaLejaKnotsAndWeights50(alpha,beta) above. 
% 
% [x,w]=compute_BetaLejaKnotsAndWeights50(alpha,beta,'nonprob') 
% calculates the collocation points and the weights 
% for the weighted Leja sequence for integration 
% w.r.t to the weight function 
%
