...
switch nargin
    ...
    case 3
        ...
        errmsg=[' Starting from release 14.3 QUADRATURE_ON_SPARSE_GRID does not accept 3 input arguments. '...
    ...
    case 4
        ...
        % or
        % res = QUADRATURE_ON_SPARSE_GRID(f,S,[],[])
        if ( isa(evals_old,'function_handle') || isempty(evals_old)) && ~isstruct(S_old)
            errmsg=['Unrecognized inputs. Note that starting from release 14.3 '...
