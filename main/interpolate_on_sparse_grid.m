...
if size(function_on_grid,2)~=nb_points_Sr
    ...
    % function
    error([ 'Incompatible sizes. Starting from release 14.4 function_on_grid needs to store evaluations on grid as columns, '...
...
if size(non_grid_points,1)~=N
    error([ 'Incompatible sizes. Starting from release 14.4 non_grid_points needs to store points as columns, '...
