...
% pts_list, while the other fields are empty[]. Thus, isreduced(S)==true and
% S can then be used as input to e.g. evaluate_on_sparse_grid. The knots in pts_list are supposed
